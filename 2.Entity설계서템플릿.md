...
| **taskState** | `TaskStatus` | `Task_State` | NOT NULL, ENUM | 진행 상태 | TODO, IN_PROGRESS, DONE |
...
### 4.4 Approval Entity (LeaveRequest 테이블)
...
| **usedDays** | `BigDecimal` | `used_days` | NULL 허용 | 해당 결재로 소모되는 일수 | 연차/반차 연동 |
